...
<div id="employment_wrap">
    <form id="employment_form" action="" method="POST">
        <h4 style="display: block; text-align: center;margin-bottom: 80px; ">لطفا اطلاعات خواسته شده را وارد نمایید.</h4>
...
<div class="m_info">
        ...
        <?php else : ?>
            <tr class="no-items">
                <td class="colspanchnage" colspan="9"><?php _e( 'موردی یافت نشد!' ); ?></td>
            </tr>
        <?php endif; ?>
